...
/*                                                              */
/*    NAME: genex2                                            */
/*   TITLE: Example 2 for PROC GENSELECT                      */
/* PRODUCT: STAT                                                */
/*  SYSTEM: ALL                                                 */
/*    KEYS: Gamma regression analysis                         */
/*   PROCS: GENSELECT                                         */
/*    DATA:                                                     */
/*                                                              */
/*     REF: SAS/HPA User's Guide, PROC GENSELECT chapter      */
/*    MISC:                                                     */
/*                                                              */
/****************************************************************/

/*****************************************************************
Example 2: Gamma Regression Model
*****************************************************************/

/*
The data, from the Getting Started example (gengs1), consists of
100 observations on a numeric response variable Total,
and five numerical categorical variables C1--C5.
A main effects log linked Gamma regression model
...
title 'Example 2: Gamma Regression';
